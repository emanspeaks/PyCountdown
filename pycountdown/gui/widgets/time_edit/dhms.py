from pyrandyos.gui.qt import Qt, QKeyEvent
from pyrandyos.gui.widgets import GuiWidgetParentType
from pyrandyos.utils.time.dhms import sec_to_dhms, dhms_to_sec
